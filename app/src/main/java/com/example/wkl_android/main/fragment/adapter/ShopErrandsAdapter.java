...
public class ShopErrandsAdapter extends BaseAdapter<GoodsListBean.GoodsPlateVOList, ShopErrandsAdapter.ViewHolder> {
    public ShopErrandsAdapter(Context context, List<GoodsListBean.GoodsPlateVOList> data) {
        super(context, data);
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_shop_errands, parent, false);
