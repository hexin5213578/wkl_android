...
package com.example.wkl_android.widget.wheel;
...
import com.example.wkl_android.widget.wheel.adapters.WheelViewAdapter;
...
//    private int[] SHADOWS_COLORS = new int[]{0xefE9E9E9, 0xcfE9E9E9, 0x00AAAAAA};
    private int[] SHADOWS_COLORS = new int[]{0xEFFFFFFF, 0xCFFFFFFF, 0x00FFFFFF};
    ...
    private void drawShadows(Canvas canvas) {
         ...
         * getItemHeight()); //
         */
        int height = (visibleItems - 1) * getItemHeight() / 2;
        // */
