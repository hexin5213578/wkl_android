package com.example.wkl_android.widget.flowlayout;
...
public class TagFlowLayout extends FlowLayout
    ...
    private void changeAdapter() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tagView.setDuplicateParentStateEnabled(mTagAdapter.setEnabled(i,adapter.getItem(i)));
            tagViewContainer.setEnabled(mTagAdapter.setEnabled(i,adapter.getItem(i)));
