package com.example.wkl_android.order.evaluate;
...
public class EvaluateActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initViews() {
        ...
        initMap();
        initListeners();
        adapter = new ImagePickerAdapter(this, new ArrayList<String>(), false, 5);
        ...
        adapter.setListener(new ImagePickerAdapter.OnClickListener() {
            ...
            public void onPreview(View view, List<String> data, int position) {
                ImagePreviewDialog dialog = new ImagePreviewDialog(EvaluateActivity.this,
                        data, position);
                dialog.show();
            }
        });
