...
public class GridImageAdapter extends
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) viewHolder.rl_bg.getLayoutParams();
        int width = (ScreenUtils.getScreenWidth(context) - DisplayUtil.dp2px(context , 30)) / 3;
        params.width = width;
        params.height = width;

        if (getItemViewType(position) == TYPE_CAMERA) {

            RelativeLayout.LayoutParams ivparams = (RelativeLayout.LayoutParams) viewHolder.mImg.getLayoutParams();
