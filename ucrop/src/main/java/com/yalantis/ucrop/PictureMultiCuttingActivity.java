...
import com.yalantis.ucrop.util.SharedPreUtil;
...
//        findViewById(R.id.ucrop_frame).setBackgroundColor(mRootViewBackgroundColor);
    ...
    protected void resetCutData() {
        ...
        String name = SharedPreUtil.getString(this, "uc", "name");
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            extras.putParcelable(UCropMulti.EXTRA_OUTPUT_URI,
                    Uri.fromFile(new File(getCacheDir(), name + imgType)));
            SharedPreUtil.putValue(this, "uc", "name", "");
        }
